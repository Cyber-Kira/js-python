...
gulp.task("copy-lessons", () => {
  return gulp.src("./src/pages/lessons/*.html")
              .pipe(gulp.dest(dist + "/pages/lessons/"))
              .pipe(browsersync.stream());
});

gulp.task("copy-labs", () => {
  return gulp.src("./src/pages/labs/*.html")
...
gulp.task("copy-quiz", () => {
  return gulp.src("./src/pages/quiz/*.html")
...
gulp.task("build", gulp.parallel("copy-html", "copy-assets", "build-css", "build-js", "copy-lessons", "copy-labs", "copy-pract", "copy-quiz"));
